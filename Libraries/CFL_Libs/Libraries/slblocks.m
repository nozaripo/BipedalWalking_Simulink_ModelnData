...
%
blkStruct.Name = ['Simscape Multibody Contact Forces Library'];
%
...
%
blkStruct.MaskDisplay = 'Simscape Multibody Contact Forces Library';
...
%blkStruct.Browser(2).Name    = 'Simscape Multibody Contact Forces Library';

%blkStruct.Browser(1).Library = 'Contact_Forces_Lib';
%blkStruct.Browser(1).Name    = 'Simscape Multibody Contact Forces Library';

Browser(1).Library = 'Contact_Forces_Lib';
Browser(1).Name    = 'Simscape Multibody Contact Forces Library';
